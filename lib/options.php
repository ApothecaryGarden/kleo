    ...
    'customizer' => true,
		...
		'fields' => array(
            array(
                ...
                'options' => array(
                    'normal' => array('alt' => 'Normal header', 'img' => KLEO_FW_URI . '/assets/img/header_normal.png'),
                    'extras' => array('alt' => 'Extras header', 'img' => KLEO_FW_URI . '/assets/img/header_extras.png'),
                    'split' => array('alt' => 'Split header', 'img' => KLEO_FW_URI . '/assets/img/header_split.png'),
                    'lp' => array('alt' => 'LP header', 'img' => KLEO_FW_URI . '/assets/img/header_lp.png'),
                    'right_logo' => array('alt' => 'Right logo', 'img' => KLEO_FW_URI . '/assets/img/header_logo_to_right.png'),
                    'center_logo' => array('alt' => 'Center logo', 'img' => KLEO_FW_URI . '/assets/img/header_centered.png'),
                    'left_logo' => array('alt' => 'Left logo and menu', 'img' => KLEO_FW_URI . '/assets/img/header_left.png'),
                ),
                'default' => 'normal'
            ),
            array(
			...
			array(
				...
				'type' => 'text',
				'required' => array( array('resize_logo','equals','1'), array('header_layout','equals',array('left_logo', 'center_logo')) ),
